...
pub use dosfile::{
    ...
    ERROR_FILE_NOT_OBJECT, ERROR_INVALID_COMPONENT_NAME, ERROR_INVALID_LOCK, ERROR_NO_FREE_STORE,
    ERROR_OBJECT_EXISTS, ERROR_OBJECT_IN_USE, ERROR_OBJECT_NOT_FOUND, ERROR_OBJECT_WRONG_TYPE,
    ERROR_SEEK_ERROR, MODE_NEWFILE, MODE_OLDFILE, MODE_READWRITE, OFFSET_BEGINNING, OFFSET_CURRENT,
    OFFSET_END,
};
pub use doslock::{
